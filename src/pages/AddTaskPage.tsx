    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      >
        <div className="bg-primary-600 px-8 py-6 text-white">
          ...
          <p className="text-primary-100 text-sm mt-1">Keep track of your academic deadlines precisely.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="bg-blue-50 p-4 rounded-2xl flex gap-3">
             ...
             <p className="text-xs text-blue-800 leading-relaxed">
               Adding a task will automatically trigger the <strong>Collision Detector</strong> to check if this date clashes with other scheduled academic activities.
             </p>
          </div>
